...
public class ConformOrder {
	...
	private User conformOrderUser;
	
	@ManyToOne
	@JoinColumn(name = "productId")
	private Products ConformOrderProduct;
	...
	public User getOrderUser() {
		return conformOrderUser;
	}

	public void setOrderUser(User orderUser) {
		this.conformOrderUser = orderUser;
	}

	public Products getOrderProducts() {
		return ConformOrderProduct;
	}

	public void setOrderProducts(Products orderProducts) {
		this.ConformOrderProduct = orderProducts;
	}
